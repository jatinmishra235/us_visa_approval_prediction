import boto3
import os
from us_visa.constant import AWS_ACCESS_KEY_ID_ENV_KEY, AWS_SECRET_ACCESS_KEY_ENV_KEY, REGION_NAME
...
class S3Client:
    ...
    def __init__(self,region_name = REGION_NAME):
        """
        This class gets aws credentials from env_variable and creates an connection with aws bucket
